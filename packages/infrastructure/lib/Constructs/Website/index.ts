...
import { OriginAccessIdentity, CloudFrontWebDistribution, HttpVersion, PriceClass, CloudFrontAllowedMethods, ViewerProtocolPolicy } from '@aws-cdk/aws-cloudfront';
